...
const RULES_1: ModifierRule[] = [
  ...
  {
    id: 'adm_benedictions_citation',
    label: 'Benedictions — Citation in Savagery: +1 F y +1 A CaC (si cargó)',
    description: 'Data-Psalm Conclave: Each time a CULT MECHANICUS model makes a melee attack, if that model\'s unit made a Charge move this turn, add 1 to the Strength and Attacks characteristics of that weapon.',
    factionId: 'AdM',
    detachmentId: '000000821',
    combatType: 'melee',
    effects: { strengthMod: 1, attacksMod: 1 },
  },
  {
  ...
  { id: 'adm_threat_cogitation_targeters', label: 'THREAT-COGITATION TARGETERS — rerollar daño vs MONSTER/VEHICLE, disparo (1CP)', description: 'Eradication Cohort: Until the end of the phase, each time a ranged attack made by a model in your unit is allocated to a MONSTER or VEHICLE model, you can re-roll the Damage roll.', factionId: 'AdM', detachmentId: '000001143', combatType: 'ranged', isStratagem: true, cpCost: 1, effects: { rerollAllDamage: true } },
  { id: 'adm_servo_driven_charge', label: 'SERVO-DRIVEN CHARGE — LANCE CaC: +1 herir vs MONSTER/VEHICLE (1CP)', description: 'Eradication Cohort: Until the end of the phase, melee weapons equipped by models in your unit have the [LANCE] ability. (LANCE: each time the bearer makes an attack targeting a MONSTER or VEHICLE, add 1 to the Wound roll.)', factionId: 'AdM', detachmentId: '000001143', combatType: 'melee', isStratagem: true, cpCost: 1, effects: { woundMod: 1 } },
  {
  ...
  {
    id: 'adm_procedural_elimination_ranged',
    label: 'Procedural Elimination — repetir impactos 1, disparo',
    description: 'Response Clade: At the start of the battle round, if ranged attacks are selected, each time a SKITARII model makes a ranged attack, re-roll a Hit roll of 1.',
    factionId: 'AdM',
  ...
  {
    id: 'adm_procedural_elimination_melee',
    label: 'Procedural Elimination — repetir impactos 1, CaC',
    description: 'Response Clade: At the start of the battle round, if melee attacks are selected, each time a SKITARII model makes a melee attack, re-roll a Hit roll of 1.',
    factionId: 'AdM',
    detachmentId: '000000913',
    combatType: 'melee',
    effects: { rerollHitsOf1: true },
  ...
  {
    id: 'adm_precognitated_firefields_1',
    label: 'PRECOGNITATED FIREFIELDS — Sustained Hits 1, disparo (1CP)',
    description: 'Response Clade: Until the end of the phase, ranged weapons equipped by models in your unit have the [SUSTAINED HITS 1] ability.',
    factionId: 'AdM',
    detachmentId: '000000913',
    combatType: 'ranged',
    isStratagem: true,
  ...
  {
    id: 'adm_precognitated_firefields_2',
    label: 'PRECOGNITATED FIREFIELDS — Sustained Hits 2, disparo — Battleline (1CP)',
    description: 'Response Clade: Until the end of the phase, if your unit has the BATTLELINE keyword, ranged weapons have the [SUSTAINED HITS 2] ability instead.',
    factionId: 'AdM',
    detachmentId: '000000913',
    combatType: 'ranged',
    isStratagem: true,
...
const RULES_5: ModifierRule[] = [
  ...
  // ── Overwatch 5+ — stratagemas ────────────────────────────────────────────
  {
    id: 'ae_shield_of_blades',
    label: 'Shield of Blades — overwatch 5+ (1CP)',
    description: 'Protector Host: each time a model in your unit makes an attack while firing Overwatch, an unmodified Hit roll of 5+ is required to score a hit, instead of an unmodified 6.',
    factionId: 'AE',
    detachmentId: '000000920',
    combatType: 'ranged',
    isStratagem: true,
    cpCost: 1,
    effects: { overwatchThreshold: 5 },
  },
  {
    id: 'ae_unflinching_fire',
    label: 'Unflinching Fire — overwatch 5+ (1CP)',
    description: 'Wraiths of the Void: each time a model in your unit makes an attack while firing Overwatch, an unmodified Hit roll of 5+ is required to score a hit, instead of an unmodified 6.',
    factionId: 'AE',
    detachmentId: '000000921',
    combatType: 'ranged',
    isStratagem: true,
  ...
  {
    id: 'am_brutal_choke_point',
    label: 'Brutal Choke Point — overwatch 5+ (1CP)',
    description: 'Embarked Regiment: each time a model in your unit makes an attack while firing Overwatch, an unmodified Hit roll of 5+ is required to score a hit, instead of an unmodified 6.',
    factionId: 'AM',
    detachmentId: '000000927',
    combatType: 'ranged',
    isStratagem: true,
  ...
  {
    id: 'aoi_ships_watch',
    label: "Ship's Watch — overwatch 5+ (1CP)",
    description: "Voidship's Company: each time a model in one of your units makes an attack while firing Overwatch, an unmodified Hit roll of 5+ is required to score a hit. If the unit contains a Canid model, a successful unmodified Hit roll of 5+ also scores a Critical Hit.",
    factionId: 'AoI',
    detachmentId: '000000924',
    combatType: 'ranged',
    isStratagem: true,
  ...
  {
    id: 'as_repel_boarders',
    label: 'Repel Boarders — overwatch 5+ (1CP)',
    description: 'Pious Protectors: each time a model in your unit makes an attack while firing Overwatch, an unmodified Hit roll of 5+ is required to score a hit, instead of an unmodified 6.',
    factionId: 'AS',
    detachmentId: '000000916',
    combatType: 'ranged',
    isStratagem: true,
  ...
  {
    id: 'lov_corridor_covered',
    label: 'Corridor Covered — overwatch 5+ (1CP)',
    description: 'Void Salvagers: each time a model in your unit makes an attack while firing Overwatch, an unmodified Hit roll of 5+ is required to score a hit, instead of an unmodified 6.',
    factionId: 'LoV',
    detachmentId: '000000950',
    combatType: 'ranged',
    isStratagem: true,
  ...
  {
    id: 'sm_cleansing_sweep',
    label: 'Cleansing Sweep — overwatch 5+ (1CP)',
    description: 'Terminator Assault: each time a model in your unit makes an attack while firing Overwatch, an unmodified Hit roll of 5+ is required to score a hit, instead of an unmodified 6.',
    factionId: 'SM',
    detachmentId: '000000907',
    combatType: 'ranged',
    isStratagem: true,
  ...
  {
    id: 'tau_pulse_barrage',
    label: 'Pulse Barrage — overwatch 5+ (1CP)',
    description: 'Starfire Cadre: each time a model in your unit makes an attack while firing Overwatch, an unmodified Hit roll of 5+ is required to score a hit, instead of an unmodified 6.',
    factionId: 'TAU',
    detachmentId: '000000966',
    combatType: 'ranged',
    isStratagem: true,
  ...
  // ── Overwatch 5+ — habilidades de datasheet ───────────────────────────────
  {
    id: 'ds_000000459_sentinel_protocols',
    label: 'Drone Sentry Turret — overwatch 5+ (Sentinel Protocols)',
  ...
  {
    id: 'ds_000000472_defensive_stance',
    label: 'Hive Guard — overwatch 5+ (Defensive Stance)',
    ...
    factionId: 'TYR',
    datasheetId: '000000472',
    combatType: 'ranged',
    effects: { overwatchThreshold: 5 },
  },
  {
    id: 'ds_000000686_covering_fire',
    label: 'Cadian Heavy Weapons Squad — overwatch 5+ (Covering Fire)',
    ...
    factionId: 'AM',
    datasheetId: '000000686',
    combatType: 'ranged',
    effects: { overwatchThreshold: 5 },
  },
  {
    id: 'ds_000000752_armoured_defender',
    label: 'Malcador Defender — overwatch 5+ (Armoured Defender)',
    ...
    factionId: 'AM',
    datasheetId: '000000752',
    combatType: 'ranged',
    effects: { overwatchThreshold: 5 },
  },
  {
    id: 'ds_000000758_sentinel_directives',
    label: 'Sabre Weapons Battery — overwatch 5+ (Sentinel Directives)',
    ...
    factionId: 'AM',
    datasheetId: '000000758',
    combatType: 'ranged',
    effects: { overwatchThreshold: 5 },
  },
  {
    id: 'ds_000000842_sentinel_directives',
    label: 'Kataphron Destroyers — overwatch 5+ (Sentinel Directives)',
    description: 'Each time you target this unit with the Fire Overwatch Stratagem, hits are scored on unmodified Hit rolls of 5+ when resolving that Stratagem.',
    factionId: 'AdM',
    datasheetId: '000000842',
    combatType: 'ranged',
    effects: { overwatchThreshold: 5 },
  },
  {
    id: 'ds_000001030_destroyer_of_futures',
    label: 'Defiler — overwatch 5+ (Destroyer of Futures)',
    ...
    factionId: 'TS',
    datasheetId: '000001030',
    combatType: 'ranged',
    effects: { overwatchThreshold: 5 },
  },
  {
    id: 'ds_000002115_sentinel_construct',
    label: 'Canoptek Doomstalker — overwatch 5+ (Sentinel Construct)',
    ...
    factionId: 'NEC',
    datasheetId: '000002115',
    combatType: 'ranged',
    effects: { overwatchThreshold: 5 },
  },
  {
    id: 'ds_000002732_covering_fire',
    label: 'Renegade Heavy Weapons Squad — overwatch 5+ (Covering Fire)',
    description: 'Each time you target this unit with the Fire Overwatch Stratagem, while resolving that Stratagem, hits are scored on unmodified Hit rolls of 5+.',
    factionId: 'CSM',
    datasheetId: '000002732',
    combatType: 'ranged',
    effects: { overwatchThreshold: 5 },
  },
  {
    id: 'ds_000003857_covering_fire',
    label: 'Renegade Heavy Weapons Squad (QT) — overwatch 5+ (Covering Fire)',
    description: 'Each time you target this unit with the Fire Overwatch Stratagem, while resolving that Stratagem, hits are scored on unmodified Hit rolls of 5+.',
    factionId: 'QT',
    datasheetId: '000003857',
    combatType: 'ranged',
    effects: { overwatchThreshold: 5 },
  },
  {
    id: 'ds_000003959_sentinel_directives',
    label: 'Sabre Weapons Battery (GC) — overwatch 5+ (Sentinel Directives)',
    description: 'Each time you target this unit with the Fire Overwatch Stratagem, hits are scored on unmodified Hit rolls of 5+ when resolving that Stratagem.',
    factionId: 'GC',
    datasheetId: '000003959',
    combatType: 'ranged',
    effects: { overwatchThreshold: 5 },
  },
  {
    id: 'ds_000003967_covering_fire',
    label: 'Cadian Heavy Weapons Squad (GC) — overwatch 5+ (Covering Fire)',
    description: 'Each time you target this unit with the Fire Overwatch Stratagem, while resolving that Stratagem, hits are scored on unmodified Hit rolls of 5+, or on unmodified Hit rolls of 4+ instead if this unit is within 6" of one or more friendly Platoon units.',
    factionId: 'GC',
    datasheetId: '000003967',
    combatType: 'ranged',
    effects: { overwatchThreshold: 5 },
  },
  {
    id: 'ds_000004017_armoured_defender',
    label: 'Malcador Defender (GC) — overwatch 5+ (Armoured Defender)',
    description: 'Each time you target this model with the Fire Overwatch Stratagem, hits are scored on unmodified Hit rolls of 5+ while resolving that Stratagem.',
    factionId: 'GC',
    datasheetId: '000004017',
    combatType: 'ranged',
    effects: { overwatchThreshold: 5 },
  },
  {
    id: 'ds_000004058_covering_fire',
    label: 'Renegade Heavy Weapons Squad (CD) — overwatch 5+ (Covering Fire)',
    description: 'Each time you target this unit with the Fire Overwatch Stratagem, while resolving that Stratagem, hits are scored on unmodified Hit rolls of 5+.',
    factionId: 'CD',
    datasheetId: '000004058',
    combatType: 'ranged',
    effects: { overwatchThreshold: 5 },
  },
  {
    id: 'ds_000004143_purge_response',
    label: 'Ironkin Steeljacks — overwatch 5+ (Purge Response)',
